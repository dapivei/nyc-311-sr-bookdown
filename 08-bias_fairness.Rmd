...
En la gráfica anterior, notamos que hay una diferencia en la distribución de las predicciones por distrito. Por ejemplo, una gran mayoría de las predicciones de _Bronx_ no están por encima de la media, mientras que alrededor de la mitad de las predicciones de Manhattan y Queens, predicen demandan de 
...
* Proportional Parity: auditamos si cada distrito está representado proporcionalmente a su representación en la población en general.
